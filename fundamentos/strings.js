...
console.log(escola.substring(1))//retorna um substring a partir do índice indicado
...
console.log(escola.replace(3, 'e'))//susbtitui o caracter indicado pelo literal indicado.
