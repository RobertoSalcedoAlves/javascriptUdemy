...
console.log(valores[100]) // quando um índice que não existe é chamado NÃO GERA ERRO - valor "undefined"

valores[4] = 10 // o array não tem tamanho fixo, pode aumentar ou diminuir conforme a necessidade
console.log(valores)
console.log(valores.length) // identificar o tamanho do array
...
delete valores[0] // esse recurso permite excluir o conteúdo de um índice específico no array
console.log(valores)
